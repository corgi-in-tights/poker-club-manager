...
MIGRATION_MODULES = {"sites": "poker_club_manager.contrib.sites.migrations"}
...
ADMINS = [("""Reyaan C""", "59304120+corgi-in-tights@users.noreply.github.com")]
...
ACCOUNT_FORMS = {"signup": "poker_club_manager.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "poker_club_manager.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "poker_club_manager.users.forms.UserSocialSignupForm"}
# django-compressor
# ------------------------------------------------------------------------------
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Poker Club Manager API",
    "DESCRIPTION": "Documentation of API endpoints of Poker Club Manager",
    "VERSION": "1.0.0",
